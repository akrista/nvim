...
> `akrista` with `<your_github_username>` in the commands below

<details><summary> Linux and Mac </summary>

```sh
git clone -b akrista https://github.com/akrista/nvim "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone -b akrista https://github.com/akrista/nvim "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone -b akrista https://github.com/akrista/nvim "${env:LOCALAPPDATA}\nvim"
```
